...
print(f"Nombre de labels disponibles : {len(labels_dict)}")
...
print(f"Nombre d'images .jpg non segmentées : {len(fichiers_non_seg)}")
...
print("Distribution des labels (hors null) :")
